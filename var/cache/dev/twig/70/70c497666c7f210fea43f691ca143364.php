...
/* exercice/liste_exerciceE.html.twig */
class __TwigTemplate_ff8f45350d6791f167bd349da65b9f2e extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "exercice/liste_exerciceE.html.twig"));
...
<body>
    ...
    <div class=\"card shadow-lg p-4\" style=\"background-color: #FDF4E3; border-radius: 10px;\">
        <h1 class=\"text-center mb-4\" style=\"color: #8E44AD; font-weight: bold;\">📚 Liste des Exercices</h1>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["exercices"]) || array_key_exists("exercices", $context) ? $context["exercices"] : (function () { throw new RuntimeError('Variable "exercices" does not exist.', 361, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["exercice"]) {
            ...
            yield "                        <tr>
                            <td><span>";
            // line 363
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "createdAt", [], "any", false, false, false, 363), "d M Y"), "html", null, true);
            yield "</span></td>
                            <td><h4 class=\"title\">";
            // line 364
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "titre", [], "any", false, false, false, 364), "html", null, true);
            yield "</h4></td>
                            <td>
                             <a href=\"";
            // line 366
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_exercice_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "id", [], "any", false, false, false, 366)]), "html", null, true);
            yield "\" class=\"btn btn-sm\" style=\"background-color: #F4D03F; color: #4A235A; border-radius: 5px; font-weight: bold;\">👀 Modifier</a>

                            <a href=\"";
            // line 368
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_exercice_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "id", [], "any", false, false, false, 368)]), "html", null, true);
        ...
        if (!$context['_iterated']) {
            // line 372
            yield "                        <tr>
                            <td colspan=\"3\" class=\"text-center text-muted\">Aucun exercice trouvé.</td>
                        </tr>
                    ";
        }
        ...
        yield "\" class=\"btn\" style=\"background-color: #F7CA18; color: #4A235A; padding: 10px 20px; border-radius: 10px; font-weight: bold;\">➕ Ajouter un exercice</a>
        </div>
    </div>
</div>
";
    ...
    {
        return "exercice/liste_exerciceE.html.twig";
    }
    ...
    {
        return array (  907 => 381,  900 => 376,  891 => 372,  889 => 375,  881 => 368,  876 => 366,  871 => 364,  867 => 363,  864 => 362,  859 => 361,  843 => 347,  833 => 346,  812 => 11,  802 => 10,  785 => 7,  395 => 386,  393 => 346,  297 => 253,  293 => 252,  64 => 25,  62 => 10,  56 => 7,  48 => 1,);
    }
...
<div class=\"container mt-5\">
    <div class=\"card shadow-lg p-4\" style=\"background-color: #FDF4E3; border-radius: 10px;\">
            ...
            <table class=\"table table-hover table-bordered\" style=\"background-color: #FFF9C4; border-radius: 10px;\">
                ...
                <tbody>
                    {% for exercice in exercices %}
                        <tr>
                            <td><span>{{ exercice.createdAt|date('d M Y') }}</span></td>
                            <td><h4 class=\"title\">{{ exercice.titre }}</h4></td>
                            <td>
                             <a href=\"{{ path('app_exercice_edit', {'id': exercice.id}) }}\" class=\"btn btn-sm\" style=\"background-color: #F4D03F; color: #4A235A; border-radius: 5px; font-weight: bold;\">👀 Modifier</a>

                            <a href=\"{{ path('app_exercice_show', {'id': exercice.id}) }}\" class=\"btn btn-sm\" style=\"background-color: #F4D03F; color: #4A235A; border-radius: 5px; font-weight: bold;\">👀 Voir</a>
                            </td>
                        </tr>
                    {% else %}
                        <tr>
        ...
        <div class=\"text-center mt-4\">
            <a href=\"{{ path('app_exercice_new') }}\" class=\"btn\" style=\"background-color: #F7CA18; color: #4A235A; padding: 10px 20px; border-radius: 10px; font-weight: bold;\">➕ Ajouter un exercice</a>
        </div>
    </div>
</div>
{% endblock %}
...
</html>", "exercice/liste_exerciceE.html.twig", "/Users/cyrineberrabah/Downloads/Novalearn-cyrine /templates/exercice/liste_exerciceE.html.twig");
    }
}
