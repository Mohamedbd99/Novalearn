...
/* signup.html.twig */
class __TwigTemplate_93cb2f14a6db6273137eb90901329e55 extends Template
{
   ...
   <section class=\"rts-contact-area rts-section-gap inner\" style=\"background: linear-gradient(135deg, #f5f7fa, #c3cfe2); padding: 80px 0; position: relative;\">
    ...
    <div class=\"container\">
        ...
        <div class=\"form-container\" style=\"display: flex; justify-content: center; align-items: center;\">
            <div class=\"col-lg-7\">
                <form action=\"#\" class=\"contact-form\" style=\"background: white; padding: 40px; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);\">
                    <h3 class=\"heading-title text-center\">S'inscrire</h3>
                    <div class=\"form-inner\">
                        ...
                        <div class=\"single-input\">
                            <input type=\"text\" name=\"Number\" placeholder=\"Numéro De Téléphone\" required>
                            <i class=\"fas fa-phone\"></i>
                        </div>

                        <div class=\"single-input\">
                            <select class=\"nice-select\" name=\"difficulty\">
                                <option>Difficulté</option>
                                <option value=\"read\">Lire</option>
                                <option value=\"write\">Écrire</option>
                                <option value=\"hear\">Entendre</option>
                        ...
                        <div class=\"single-input\">
                            <select class=\"nice-select\" name=\"difficulty-level\">
    ...
    {
        return array (  709 => 11,  699 => 10,  682 => 7,  63 => 25,  61 => 10,  55 => 7,  47 => 1,);
    }
...
</html>", "signup.html.twig", "/Users/cyrineberrabah/Desktop/piDev/Novalearn-new_project-3/templates/signup.html.twig");
    }
}
