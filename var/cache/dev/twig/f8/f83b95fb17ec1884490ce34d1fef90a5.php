...
class __TwigTemplate_7092e675ffdbef77ba92cc15565663ae extends Template
{
...
<body>
                ...
                <div class=\"col-lg-12\">
                    <div class=\"breadcrumb-main-wrapper\">
                        <div class=\"pagination-wrapper\">
                            ...
                            <a class=\"active\" href=\"event.html\">exercices</a>
    ...
    <!-- exercices area start -->
<section class=\"rts-event-area inner rts-section-gap\">
    <div class=\"container\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["exercices"]) || array_key_exists("exercices", $context) ? $context["exercices"] : (function () { throw new RuntimeError('Variable "exercices" does not exist.', 178, $this->source); })()));
                        ...
                        <div class=\"event-wrapper inner\">
                            <div class=\"wrapper-inner bg-one\">
                                <div class=\"date\">
                                    <span>";
            // line 183
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "createdAt", [], "any", false, false, false, 183), "d M Y"), "html", null, true);
            yield "</span>
                                    <img src=\"assets/images/events/01.png\" width=\"132\" alt=\"\" class=\"shape\">
                                </div>
                                <div class=\"content\">
                                    <!-- Lien dynamique vers la page de détails de l'exercice -->
                                    <a href=\"";
            // line 188
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_exercice_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "id", [], "any", false, false, false, 188)]), "html", null, true);
            yield "\">
                                        <h4 class=\"title\">";
            // line 189
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "titre", [], "any", false, false, false, 189), "html", null, true);
            yield "</h4>
                                    </a>
                                    <ul class=\"meta-wrapper\">
                                        <li><i class=\"fa-regular fa-clock\"></i> ";
            // line 192
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, $context["exercice"], "createdAt", [], "any", false, false, false, 192), "H:i"), "html", null, true);
            yield "</li>
                                    </ul>
                                </div>
    ...
    {
        return array (  269 => 200,  255 => 192,  249 => 189,  245 => 188,  237 => 183,  231 => 179,  227 => 178,  162 => 116,  45 => 1,);
    }
                        ...
                        <nav>
                            <ul>
                                ...
                                <li class=\"has-dropdown\">
                                    <a class=\"nav-link\" href=\"#\">Classes</a>
                                    <ul class=\"submenu\">
                                    <li><a href=\"{{ path('app_course_user') }}\">Cours</a></li>
                                        <li><a href=\"\">Exercices</a></li>
                                    </ul>
                                </li>
                ...
                {% for exercice in exercices %}
                    <div class=\"col-lg-6\">
                        <div class=\"event-wrapper inner\">
                            <div class=\"wrapper-inner bg-one\">
                                <div class=\"date\">
                                    <span>{{ exercice.createdAt|date('d M Y') }}</span>
                                    <img src=\"assets/images/events/01.png\" width=\"132\" alt=\"\" class=\"shape\">
                                </div>
                                <div class=\"content\">
                                    <!-- Lien dynamique vers la page de détails de l'exercice -->
                                    <a href=\"{{ path('app_exercice_show', {'id': exercice.id}) }}\">
                                        <h4 class=\"title\">{{ exercice.titre }}</h4>
                                    </a>
                                    <ul class=\"meta-wrapper\">
                                        <li><i class=\"fa-regular fa-clock\"></i> {{ exercice.createdAt|date('H:i') }}</li>
                                    </ul>
                                </div>
                                <div class=\"shape-icon\"><img src=\"assets/images/events/event-blink.svg\" alt=\"\"></div>
                            </div>
...
</html>", "exercice/index.html.twig", "/Users/cyrineberrabah/Downloads/Novalearn-cyrine /templates/exercice/index.html.twig");
    }
}
