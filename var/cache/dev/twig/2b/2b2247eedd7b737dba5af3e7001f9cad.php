...
<li class=\"nav-item\" role=\"presentation\">
    ...
    <button class=\"nav-link\" id=\"exercises-tab\" onclick=\"window.location.href='";
        ...
        yield "</h5>
                                ...
                                <p class=\"disc\">";
        // line 233
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["course"]) || array_key_exists("course", $context) ? $context["course"] : (function () { throw new RuntimeError('Variable "course" does not exist.', 233, $this->source); })()), "description", [], "any", false, false, false, 233), "html", null, true);
        yield "</p>
                    ...
                    <div class=\"course-content-wrapper-main\">
                        <h5 class=\"title\">Course Content</h5>
                         <p class=\"disc\">";
        // line 270
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["course"]) || array_key_exists("course", $context) ? $context["course"] : (function () { throw new RuntimeError('Variable "course" does not exist.', 270, $this->source); })()), "contenu", [], "any", false, false, false, 270), "html", null, true);
        yield "</p>
                    </div>
    ...
    {
        return array (  334 => 270,  294 => 233,  287 => 229,  267 => 212,  215 => 163,  186 => 137,  162 => 116,  45 => 1,);
    }
...
</html>", "course_user/details_cours.html.twig", "/Users/cyrineberrabah/Desktop/cycy-projet/templates/course_user/details_cours.html.twig");
    }
}
