...
<body>
    <div class=\"form-container\" style=\"display: flex; justify-content: center; align-items: center; flex-direction: column; padding: 20px; background-color: #f9f9f9; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\">
        <h3 class=\"heading-title text-center\" style=\"text-align: center; color: #333; font-size: 24px; margin-bottom: 20px;\"></h3>
...
";
    ...
    <div class=\"card shadow-lg p-4\" style=\"background-color: #FDF4E3; border-radius: 10px;\">
        <h1 class=\"text-center mb-4\" style=\"color: #8E44AD; font-weight: bold;\">📚 Liste des Cours</h1>

        <div class=\"table-responsive\">
            <table class=\"table table-hover table-bordered\" style=\"background-color: #FFF9C4; border-radius: 10px;\">
                <thead style=\"background-color: #DCC6E0; color: #4A235A;\">
                    <tr>
                        <th>ID</th>
                        <th>Titre</th>
                        <th>Description</th>
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["courses"]) || array_key_exists("courses", $context) ? $context["courses"] : (function () { throw new RuntimeError('Variable "courses" does not exist.', 366, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["course"]) {
            ...
            yield "                        <tr>
                            <td>";
            // line 368
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["course"], "id", [], "any", false, false, false, 368), "html", null, true);
            yield "</td>
                            <td>";
            // line 369
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["course"], "titre", [], "any", false, false, false, 369), "html", null, true);
            yield "</td>
                            <td>";
            // line 370
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["course"], "description", [], "any", false, false, false, 370), "html", null, true);
            yield "</td>
                            <td>";
            // line 371
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["course"], "contenu", [], "any", false, false, false, 371), "html", null, true);
            yield "</td>
                            <td class=\"author-name\">";
            // line 372
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["course"], "author", [], "any", false, false, false, 372), "nom", [], "any", false, false, false, 372), "html", null, true);
            yield "</td>
                            <td>
                                <a href=\"";
            // line 374
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_course_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["course"], "id", [], "any", false, false, false, 374)]), "html", null, true);
            yield "\" class=\"btn btn-sm\" style=\"background-color: #F4D03F; color: #4A235A; border-radius: 5px; font-weight: bold;\">👀 Voir</a>
                                <a href=\"";
            // line 375
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_course_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["course"], "id", [], "any", false, false, false, 375)]), "html", null, true);
            yield "\" class=\"btn btn-sm\" style=\"background-color: #A569BD; color: white; border-radius: 5px; font-weight: bold;\">✏️ Modifier</a>
                            </td>
                        </tr>
                    ";
        ...
        yield "\" class=\"btn\" style=\"background-color: #F7CA18; color: #4A235A; padding: 10px 20px; border-radius: 10px; font-weight: bold;\">➕ Ajouter un cours</a>
        </div>
    </div>
</div>
";
    ...
    {
        return array (  922 => 388,  915 => 383,  906 => 379,  904 => 382,  896 => 375,  892 => 374,  887 => 372,  883 => 371,  879 => 370,  875 => 369,  871 => 368,  868 => 367,  863 => 366,  844 => 349,  834 => 348,  813 => 11,  803 => 10,  786 => 7,  397 => 393,  395 => 348,  297 => 253,  293 => 252,  64 => 25,  62 => 10,  56 => 7,  48 => 1,);
    }
...
<div class=\"container mt-5\">
    <div class=\"card shadow-lg p-4\" style=\"background-color: #FDF4E3; border-radius: 10px;\">
                ...
                <tbody>
                    {% for course in courses %}
                        <tr>
                            ...
                            <td class=\"author-name\">{{ course.author.nom }}</td>
                            <td>
                                <a href=\"{{ path('app_course_show', {'id': course.id}) }}\" class=\"btn btn-sm\" style=\"background-color: #F4D03F; color: #4A235A; border-radius: 5px; font-weight: bold;\">👀 Voir</a>
                                <a href=\"{{ path('app_course_edit', {'id': course.id}) }}\" class=\"btn btn-sm\" style=\"background-color: #A569BD; color: white; border-radius: 5px; font-weight: bold;\">✏️ Modifier</a>
                            </td>
                        </tr>
                    {% else %}
                        <tr>
        ...
        <div class=\"text-center mt-4\">
            <a href=\"{{ path('app_course_new') }}\" class=\"btn\" style=\"background-color: #F7CA18; color: #4A235A; padding: 10px 20px; border-radius: 10px; font-weight: bold;\">➕ Ajouter un cours</a>
        </div>
    </div>
</div>
{% endblock %}
...
</html>", "course/index.html.twig", "/Users/cyrineberrabah/Downloads/Novalearn-cyrine /templates/course/index.html.twig");
    }
}
