...
return [
    ...
    [ // $dynamicRoutes
        ...
        158 => [[['_route' => 'app_course_delete', '_controller' => 'App\\Controller\\CourseController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        193 => [[['_route' => 'app_exercice_by_course', '_controller' => 'App\\Controller\\ExerciceController::indexByCourse'], ['courseId'], ['GET' => 0], null, false, true, null]],
        213 => [[['_route' => 'app_exercice_edit', '_controller' => 'App\\Controller\\ExerciceController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        229 => [[['_route' => 'app_exercice_delete', '_controller' => 'App\\Controller\\ExerciceController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        242 => [[['_route' => 'app_exercice_show', '_controller' => 'App\\Controller\\ExerciceDetController::show'], ['id'], null, null, false, true, null]],
        264 => [
