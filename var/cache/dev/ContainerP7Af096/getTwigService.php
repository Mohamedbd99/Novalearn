...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'BadWordsFilterExtension.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Twig'.\DIRECTORY_SEPARATOR.'ReclamationExtension.php';
        ...
        $instance->addExtension(new \App\Twig\BadWordsFilterExtension(($container->privates['App\\Service\\BadWordsFilter'] ??= new \App\Service\BadWordsFilter())));
        $instance->addExtension(new \App\Twig\ReclamationExtension());
