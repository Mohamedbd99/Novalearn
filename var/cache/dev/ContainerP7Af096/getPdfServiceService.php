...
class getPdfServiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Service\\PdfService'])) {
            return $container->privates['App\\Service\\PdfService'];
        }

        return $container->privates['App\\Service\\PdfService'] = new \App\Service\PdfService(($container->services['knp_snappy.pdf'] ?? $container->load('getKnpSnappy_PdfService')), $a);
    }
}
