...
class getLoginControllerAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\LoginControllerAuthenticator'])) {
            return $container->privates['App\\Security\\LoginControllerAuthenticator'];
        }

        return $container->privates['App\\Security\\LoginControllerAuthenticator'] = new \App\Security\LoginControllerAuthenticator($a, ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')));
    }
}
